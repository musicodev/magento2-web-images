...
namespace MusicoDev\WebImages\Plugin\Product\Gallery;
...
class ProcessorPlugin
{
	...
	{
		$fileMediaName = $dispersionPath . '/' . Uploader::getNewFileName($this->mediaConfig->getMediaPath($fileName));
		$fileTmpMediaName = $dispersionPath . '/' . Uploader::getNewFileName($this->mediaConfig->getTmpMediaPath($fileName));
